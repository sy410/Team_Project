...
<html lang="en">
 ...
 <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
   <div class="container-fluid">
    ...
    <section class="py-6">
      <div class="container">
      <h2 class="h4 mb-5">Notice Update</h2>
        <div class="row">
           <div class="col-md-7 mb-5 mb-md-0">
            <form class="form" id="nupdate-form" method="post" action="nupdate">
              <div class="controls">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label class="form-label" for="bfno">글번호</label>
                      <input class="form-control" type="text" name="bfno" value="${Apple.bfno}" readonly >
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="id">작성자</label>
                      <input class="form-control" type="text" name="id" value="${Apple.id}" readonly >
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label class="form-label" for="bftitle">제목 *</label>
                  <input class="form-control" type="text" name="bftitle" id="bftitle" value="${Apple.bftitle}" required="required">
                </div>
                <div class="form-group">
                  <label class="form-label" for="bqcontent">공지글 *</label>
                  <textarea class="form-control" rows="10" name="bfcontent" id="bfcontent" value="${Apple.bfcontent}" required="required"></textarea>
                </div>
