...
<script>
 ...
 <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
   <div class="container-fluid">
    ...
    <!-- Hero Section-->
    <section class="py-5 hero py-6 py-lg-7 text-white dark-overlay"><img class="bg-image" src="resources/img/noticeboard.jpg" alt="????" >
      <div class="container overlay-content">
        <!-- Breadcrumbs -->
     	<a href="rlist" class="breadcrumb text-white justify-content-center"><h1 class="hero-heading">Notice</h1></a>
      </div>
    </section>
    <section class="py-5">
      <div class="container">
                       ...
                       <div align="right">
                        <!-- 글쓰기 버튼 -->
          				<c:if test="${loginID!=null && loginID=='admin'}">
                 				<li class="nav-item mt-3 mt-lg-0 ml-lg-3 d-lg-none d-xl-inline-block"><a class="btn btn-outline-primary" href="ninsertf">글쓰기</a></li>
          				</c:if>
	...
	<c:if test="${pageMaker.prev && pageMaker.spageNo > 1}">
		<li class="page-item"><a class="page-link" href="nlist${pageMaker.searchQuery(1)}"><<</a></li>
		<li class="page-item"><a class="page-link" href="nlist${pageMaker.searchQuery(pageMaker.spageNo-1)}"><i class="fa fa-angle-left"></i></a></li>
	</c:if>
	...
	<c:forEach var="i" begin="${pageMaker.spageNo}" end="${pageMaker.epageNo}">
		...
		<c:if test ="${i != pageMaker.cri.currPage }">
			<li class="page-item "><a class="page-link" href ="nlist${pageMaker.searchQuery(i)}">${i}</a></li>
		</c:if>
	</c:forEach>
	
	<!-- 3) Next > , Last >> 처리 -->
	<c:if test="${pageMaker.next && pageMaker.epageNo > 0}">
		<li class="page-item"><a class="page-link" href="nlist${pageMaker.searchQuery(pageMaker.epageNo+1)}"><i class="fa fa-angle-right"></i></a></li>
		<li class="page-item"><a class="page-link" href="nlist${pageMaker.searchQuery(pageMaker.lastPageNo)}">>></a></li>
	</c:if>
       </ul>
      </nav>
      </div>
