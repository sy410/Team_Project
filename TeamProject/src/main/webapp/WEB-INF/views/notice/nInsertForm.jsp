      ...
      <h2 class="h4 mb-5">Notice Form</h2>
        <div class="row">
           <div class="col-md-7 mb-5 mb-md-0">
            <form class="form" id="ninsert-form" method="post" action="ninsert" enctype="multipart/form-data">
              <div class="controls">
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label class="form-label" for="bftitle">제목 <label style="color: red">*</label></label>
                  <input class="form-control" type="text" name="bftitle" id="bftitle" placeholder="Enter your title" required="required">
                </div><br>
                <div class="form-group">
                  <label class="form-label" for="bqcontent">공지글 <label style="color: red">*</label></label>
                  <textarea class="form-control" rows="10" name="bfcontent" id="bfcontent" placeholder="Enter your message" required="required"></textarea>
                </div><br>
                <div class="form-group">
