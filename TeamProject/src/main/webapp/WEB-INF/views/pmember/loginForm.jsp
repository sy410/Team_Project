...
<form action="login" method="post" class="form-validate">
    ...
    <!-- Submit-->
    <div class="d-grid">
		<button class="btn btn-lg btn-primary" type="submit" onclick="return inCheck()">Login</button>
    </div>
    <hr class="my-4">
    <p class="text-center"><small class="text-muted text-center">아직 계정이 없으신가요? <a href="joinf">&nbsp;&nbsp;&nbsp;회원가입</a></small></p>
