...
<html lang="en">
 ...
 <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
   <div class="container-fluid">
    ...
    <section class="py-6">
      <div class="container">
      <h2 class="h4 mb-5">Review Form</h2>
        <div class="row">
              ...
              <div class="controls">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="brcity">지역</label>
                      <span class="form-group"><select name="brcity" id="city" required="required">
                ...
                <div class="form-group">
                  <label class="form-label" for="brtitle">제목 <label style="color: red">*</label></label>
                  <input class="form-control" type="text" name="brtitle" id="brtitle" placeholder="Enter your title" required="required">
                </div><br>
                <div class="form-group">
                  <label class="form-label" for="bqcontent">후기글 <label style="color: red">*</label></label>
