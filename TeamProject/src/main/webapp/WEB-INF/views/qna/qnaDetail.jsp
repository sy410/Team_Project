           ...
           <div class="mt-5">
            <c:if test="${Apple2!=null}"> 
               ...
               <div class="media-body">    
                 <h5>답글 </h5> 
                 <p class="text-uppercase text-sm text-muted">관리자<i class="far fa-clock"></i> ${Apple2.bqdate}</p>
                 <div align="left"><c:if test="${loginID=='admin'}"><a href="qdelete?bqno=${Apple2.bqno}">[답글삭제]</a></c:if></div>
