   ...
   <div class="container-fluid">
       ...
       <ul class="navbar-nav ms-auto">
         ...
         <c:if test="${loginCno==null && loginID==null}">
              ...
              <c:if test="${loginID!=null && loginID =='admin'}">
                  <li class="nav-item mt-3 mt-lg-0 ml-lg-3 d-lg-none d-xl-inline-block"><a class="btn btn-primary" href="qlist">QnA</a></li>
              </c:if>        
		      </ul>
          </div>
        </div>
    ...
    <section class="hero py-6 py-lg-7 text-white dark-overlay"><img class="bg-image" src="resources/myLib/img/question.png" alt="????" >
      <div class="container overlay-content">
        <!-- Breadcrumbs -->
        <a href="#" class="breadcrumb"><h1 class="hero-heading"><br></h1></a>
      </div>
    </section>
    <section class="py-6">
      <div class="container">
      <h2 class="h4 mb-5">QnA Reply</h2>
        <div class="row">
           <div class="col-md-7 mb-5 mb-md-0">
            <form class="form" id="reply-form" method="post" action="qreply">
              <div class="controls">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label class="form-label" for="bfno">글번호</label>
                      <input class="form-control" type="text" name="bqno" value="${qnaVO.bqno}" readonly >
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                  <label class="form-label" for="bqcontent">답글 *</label>
                  <textarea class="form-control" rows="4" name="bqcontent" id="bqcontent" placeholder="Enter your message" required="required"></textarea>
                </div>
                <div>
                   <input type="text" name="root" value="${qnaVO.root}" hidden>
