...
<html lang="en">
 ...
 <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
   <div class="container-fluid">
    ...
    <section class="py-6">
      <div class="container">
       <h2 class="h4 mb-5">QnA Form</h2>
        <div class="row">
          <div class="col-md-7 mb-5 mb-md-0">
            <form class="form" id="contact-form" method="post" action="qinsert">
              <div class="controls">
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="bqtitle" id="bqtitle" placeholder="Enter your title" required="required">
                </div><br>
                <div class="form-group">
                  <label class="form-label" for="bqcontent">문의글 <label style="color: red">*</label></label>
                  <textarea class="form-control" rows="4" name="bqcontent" id="bqcontent" placeholder="Enter your message" required="required"></textarea>
                </div><br>
                 <div class="form-group">
                  <label class="form-label" for="bqpw">비밀번호 <label style="color: red">*</label></label>
                  <input class="form-control" type="password" name="bqpw" id="bqpw" placeholder="Enter your password" required="required">
                </div><br>
